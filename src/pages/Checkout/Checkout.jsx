        ...
        <div className="lg:w-1/3">
          <div className="bg-white rounded-lg shadow-sm p-6 sticky top-24">
            ...
            <button
              ...
              className={`w-full mt-6 px-6 py-3 bg-black text-white rounded-md font-medium transition-colors ${isProcessing || !selectedAddress ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-800'
                }`}
            >
